public class Game {
  public static void main(String[] args) {
    ...
    Character troll = cFactory.createCharacter(WeaponType.CLUB,
        "Lillfjant");
    cFactory = new KnightFactory();
    Character sirJames = cFactory.createCharacter(WeaponType.SWORD,
        "Sir James");
    Character blackKnight = cFactory.createCharacter(WeaponType.UNARMED,
        "Fistfighting Black Knight");
    cFactory = new OrchFactory();
    Character evilOrch = cFactory.createCharacter(WeaponType.SHOTGUN,
        "Ugly scary Orch");
    Character unarmedOrch = cFactory.createUnarmedCharacter("Ugly scary unarmed Orch");
