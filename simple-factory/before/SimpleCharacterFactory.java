public class SimpleCharacterFactory implements CharacterFactory {
    ...
    public Character createCharacter(CharacterType character, WeaponType weapon, String name) {
        switch (character) {
            case TROLL:
    ...
    public Character createUnarmedCharacter(CharacterType character, String name) {
